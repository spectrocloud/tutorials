...
DEFAULT_KUBECONFIG_DIR = None
DEFAULT_PACK_NAME = ""


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="An example Agentic workflow designed to showcase how to integrate Palette MCP into a LangChain agent workflow: Palette profile finder agent + active cluster finder agent + tagging agent + reporter agent."
    )
    parser.add_argument(
        "--pack",
    ...
    parser.add_argument(
        "--reporter-model",
        default=os.getenv("OPENAI_REPORTER_MODEL", REPORT_MODEL),
